...
def obtain_ion_name(pdb_name):
    ion_names = []
    file_handle = open('/home/yxguo/project/DockingDB/pdbs_classified/multi_ligand_pdb/{}.pdb'.format(pdb_name))
    content = file_handle.readlines()
...
def dock_it(pdb_name):
    ...
    os.system("cp /home/yxguo/project/DockingDB/pdbs_classified/multi_ligand_pdb/{}.pdb ./".format(pdb_name))
